...
// Determine if an array is a collection.
function is_collection( array $array ) {

  // Check empty arrays.
  if( [] === $array ) return false;

  // Otherwise, check arrays with items.
  return array_every($array, function($item) {

    // Every item within the array should be an associative array.
