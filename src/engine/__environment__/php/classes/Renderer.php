...
class Renderer {
  ...
  public static function compile( string $template ) {
    ...
    try {
      ...
      // Verify that the closure was generated correctly.
      if( $closure === false ) throw new Exception('A compiler error occurred. Please enabled debugging mode for more relevant error messaging.');
