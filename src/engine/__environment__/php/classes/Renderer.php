...
class Renderer {
  ...
  public static function prepare( string $template, $wrapper = 'default' ) {
    ...
    // Add benchmark point.
    if (DEBUG_ENABLED) Performance\Performance::point('Template prepared.');
  ...
  public static function render( Route $route, Data $data, Template $template ) {
    ...
    // Add benchmark point.
    if (DEBUG_ENABLED) Performance\Performance::point('Renderer', true);
    ...
    $compiler = function() use ($template, $path) {
      ...
      // Add benchmark point.
      if (DEBUG_ENABLED) Performance\Performance::point('Template compiled.');
    ...
    // Add benchmark point.
    if (DEBUG_ENABLED) Performance\Performance::finish('Renderer');
