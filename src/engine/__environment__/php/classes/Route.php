...
class Route {
  ...
  // Indicates whether the route was dynamically defined within the templating engine.
  public $dynamic = false;

  // The metadata associated with dynamically defined routes.
  public $metadata = [];
  ...
  function __construct( $path ) {
    ...
    // Otherwise, extract the route data if an array is given.
      ...
      // Indicate that the route was dynamically created.
      $this->dynamic = true;

      // Capture the dynamica metadata that was passed in.
      $this->metadata = $path;
